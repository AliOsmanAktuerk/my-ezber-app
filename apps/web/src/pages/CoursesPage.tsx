...
import { ArrowDownUp, Globe2, LockKeyhole, Pencil, Plus, RefreshCw, Save, Search, X } from 'lucide-react';
import { type FormEvent, useEffect, useMemo, useState } from 'react';
import { createCourse, type Course, getCourses, updateCourse } from '../api';
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.display({
        ...
        header: t('actions'),
        cell: (info) => (
          <button className="btn-icon" type="button" onClick={() => openEditModal(info.row.original)} aria-label={t('editCourse')}>
